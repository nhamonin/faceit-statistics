...
import { prettifyMapPickerData, getTelegramBot } from '#utils';
import {
  game_id,
  currentMapPool,
...
export async function calculateBestMapsWinrate(matchData) {
  ...
  try {
    ...
    [...new Set([...teamsToSendNotification, 146612362])]
      ...
      .map((chat_id) => {
        tBot.sendMessage(
          chat_id,
          prettifyMapPickerData(neededVariables, 'matches/winrate')
        );
      });
  } catch (e) {
    console.log(e);
